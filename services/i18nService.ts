...
const translations: Record<Language, Record<string, string>> = {
  English: {
    ...
    dashboard_subtitle: 'Central control hub for DocuHub secure assets',
  ...
  Khmer: {
    ...
    dashboard_subtitle: 'មជ្ឈមណ្ឌលគ្រប់គ្រងកណ្តាលសម្រាប់ទ្រព្យសម្បត្តិសុវត្ថិភាព DocuHub',
    ...
    login_title: 'ការចូលប្រើ DocuHub',
  ...
  Vietnam: {
    ...
    dashboard_subtitle: 'Trung tâm kiểm soát tài sản an toàn của DocuHub',
  ...
  China: {
    ...
    dashboard_subtitle: 'DocuHub 安全资产中央控制中心',
